...
void loop() {
  ...
  if (vochtpercentage < 50) {          // als het vochtpercentage lager is als 50, dan ...
    digitalWrite(waterpompPin, HIGH);  // zet waterpomp aan
  } else {                             // anders, dan ...
    digitalWrite(waterpompPin, LOW);   // zet waterpomp uit
  }
}
